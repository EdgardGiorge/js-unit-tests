...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    } // Ref. Slack e bate papo com a turma xp-a
    ...
    // ```:
    expect(Object.keys(createMenu(cardapio))).toContain('fetchMenu');
    
    // TESTE 2: Verifique se 'objetoRetornado.fetchMenu()' retorna um objeto cujas chaves são somente `food` e `drink`, 
    // considerando que a função createMenu() foi chamada com o objeto: `{ food: {}, drink: {} }`.
    // ```
    expect(Object.keys(createMenu(cardapio).fetchMenu)).toContain('food');
    // const objetoRetornado = createMenu({ food: {}, drink: {} });
    // objetoRetornado.fetchMenu() // Retorno: { food: {}, drink: {}}
    // ```
    expect(Object.keys(createMenu(cardapio).fetchMenu)).toContain('drink');
    ...
    expect(createMenu(cardapio).fetchMenu).toEqual(cardapio);
    // --------------------------------------------------------------------------------------
    ...
    expect(createMenu(cardapio).consumption).toEqual([]);
    // --------------------------------------------------------------------------------------
    ...
    let objetoRetornado = createMenu(cardapio);
    objetoRetornado.order('coxinha');
    ...
    let objetoRetornado2 = createMenu(cardapio);
    ...
    let objetoRetornado3 = createMenu(cardapio);
    objetoRetornado3.order('coxinha');
    objetoRetornado3.order('cerveja');
    objetoRetornado3.order('coxinha');
    expect(objetoRetornado3.consumption).toEqual(['coxinha', 'cerveja', 'coxinha']);
    // --------------------------------------------------------------------------------------
    ...
    let objetoRetornado4 = createMenu(cardapio);
    objetoRetornado4.order('coxinha');
    objetoRetornado4.order('cerveja');
    objetoRetornado4.order('coxinha');
    expect(objetoRetornado4.pay()).toEqual(16.17);
  });
});
